"""
Contains base problem and other functionality for the FDFD seismic case
"""
...
class SeisFDFDSurvey(Survey.BaseSurvey):
    """Seismic FDFD survey setup."""
...
class SeisFDFDProblem(Problem.BaseProblem):
    ...
    #def _initHelmholtzNinePoint25D (self, freq):
    #    for ky in self.systemConfig['kys']:

    def _initHelmholtzNinePoint (self, freq, ky=0):
        """
